        ...
        <div className="about">
            <Helmet>
                ...
                <meta name="description"
                      content="This page contains information about my skills/resume/work-experience"/>
            ...
            <div className="about-container" ref={contentRef}>
                ...
                <div className="about-description">
                    ...
                    <LinkedInIcon style={{transition: "0.3s all"}} onClick={() => {
                        window.open("https://www.linkedin.com/in/shreshth-verma-17ab39213/")
                    }} className="about-description-icon"/>


                    <div className="about-description-icon">
                        <GitHubIcon onClick={() => {
                            window.open("https://github.com/TheHamsterDog")
                        }} style={{transition: "0.3s all"}} className="about-description-icon"/>
                    </div>
                    <div className="about-description-resume">
                        <span className="about-description-resume-text text2-1">Download my </span>
                        <button className="about-description-resume-download  text2-1">resume <Ri
                            style={{fontSize: "inherit", paddingTop: ".3rem", marginLeft: ".5rem", float: "right"}}
                            className="about-description-resume-download-icon"/></button>
                    </div>
                </div>
                                ...
                                return (
                                    <div className="about-resume-section-content-skill">
                                        <div className="about-resume-section-content-skill-icon">
                                            <img className="about-resume-section-content-skill-icon-image"
